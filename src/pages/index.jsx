...
export default function Home() {
  ...
  return (
    <div className="w-screen h-screen overflow-x-hidden">
      ...
      <div className="w-full flex flex-col justify-between items-center bg-white xl:p-32 lg:p-24 lg:pb-[71px] px-5 py-14 gap-24 lg:gap-32">
        <SecondSection />
      </div>
      <div className="w-full flex-flex-col justify-center items-center bg-register bg-cover md:bg-center bg-[30%] bg-no-repeat xl:p-0" ref={ref}>
        <SignUpSection />
      </div>
