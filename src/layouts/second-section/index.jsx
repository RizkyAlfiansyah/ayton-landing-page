                    ...
                    secondSectionData.map((data, index) => {
                        return (
                            <div className='w-full flex flex-col md:gap-8 gap-6 justify-center items-center' key={index}>
                                ...
                                <p className='xl:w-64 lg:w-full md:w-96 w-60 text-center font-normal xl:text-20 xl:leading-36 text-18 leading-27 text-primary-100 md:px-0 lg:px-0'>{data.description} <br /> {data.desc}</p>
                            </div>
                        )
                    })
                }
